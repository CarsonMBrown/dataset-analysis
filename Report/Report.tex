...
Other important high performance Pandas function usage includes \code{groupby} and \code{value_counts}. On the one hand, \code{groupby} has been efficient in operating data relating one column to other columns.
